...
class RL_Model:
	...
	def __init__(self, dir, linear_speed=0.2, angular_speed=0.3):
		# ------------------------------------------------
		# dir: RL model's directory 
		# linear_speed: linear speed (x-axis) for AGV, default is 0.2
		# angular_speed: angular speed (z-axis) for AGV (not in smooth mode), default is 0.3
		# ------------------------------------------------
	...
	def restore_and_run(self, img, smooth_enable=True):
		# ----------------------------------------------------
		# img_test: input image from segmentation module
		# smooth_enable = enable smooth speed, defualt is True
		# ----------------------------------------------------
